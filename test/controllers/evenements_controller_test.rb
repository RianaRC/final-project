...
class EvenementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evenement" do
    assert_difference('Evenement.count') do
      post evenements_url, params: { evenement: { category_id: @evenement.category_id, date: @evenement.date, description: @evenement.description, price: @evenement.price, titre: @evenement.titre } }
    end
  ...
  test "should update evenement" do
    patch evenement_url(@evenement), params: { evenement: { category_id: @evenement.category_id, date: @evenement.date, description: @evenement.description, price: @evenement.price, titre: @evenement.titre } }
